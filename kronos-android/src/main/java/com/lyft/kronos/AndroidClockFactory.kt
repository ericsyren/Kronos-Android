...
object AndroidClockFactory {
    ...
    fun createKronosClock(context: Context,
        ...
        return ClockFactory.createKronosClock(deviceClock, cache, syncListener, ntpHosts, ntpPort, requestTimeoutMs, minWaitTimeBetweenSyncMs, cacheExpirationMs, maxNtpResponseTimeMs)
    }
}